(function() {
  ...
  var connect = function(params, url, cb) {
    ...
    var onmessage = function(event) {
      ...
      var str = Protocol.strdecode(event.data)
      // const bytesString = String.fromCharCode(...event.data)

    console.log('Bytes to string: ', str)
  ...
  starx.createrole = function(rolename, cb) {
    msg={}
    msg.type=""
    msg.proto="createrole"
    msg.rolename="role01"
    msg=JSON.stringify(msg);
    socket.send(msg)
  };
